...
console.log('The trapezoid with a = ' + a1 + ', b = ' + b1 + ' and h = ' + h1 + ' is: ' + calculateTrapezoidArea(a1, b1, h1));
result.innerHTML += 'The trapezoid with a = ' + a1 + ', b = ' + b1 + ' and h = ' + h1 + ' is: ' + calculateTrapezoidArea(a1, b1, h1) + '<br />';
console.log('The trapezoid with a = ' + a2 + ', b = ' + b2 + ' and h = ' + h2 + ' is: ' + calculateTrapezoidArea(a2, b2, h2));
